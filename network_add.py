...
a1 = time.time()
threads = []
t1 = threading.Thread(network.add_network(1, 6))
threads.append(t1)
t2 = threading.Thread(network.del_network())
threads.append(t2)
